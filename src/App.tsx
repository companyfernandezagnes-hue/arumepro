...
export default function App() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center">
      ...
      <p className="text-indigo-400 font-black text-[10px] tracking-[0.3em] uppercase">Sincronizando Arume...</p>
    </div>
  );
  ...
  return (
    ...
    <div id="app-root-container" className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-[110] bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex justify-between items-center shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="w-10 h-10 bg-slate-50 border border-slate-200 rounded-full flex items-center justify-center hover:bg-white hover:shadow-md transition-all text-xl"
          >
            ⚙️
          </button>
        </div>
      ...
      {/* 🔵 NAVBAR CON ID PARA DOCK Y SAFE AREAS */}
