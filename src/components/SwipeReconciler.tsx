...
import { findMatches, executeLink } from './bancoLogic';
...
export const SwipeReconciler: React.FC<SwipeReconcilerProps> = ({ data, onSave, onClose }) => {
  ...
  const currentItem = pendingMovements[currentIndex] ?? null;

  // 🚀 USAMOS EL NUEVO CEREBRO DE BÚSQUEDA (Con Scoring) — useMemo ANTES del return condicional (reglas de hooks)
