...
export const INITIAL_DATA: AppData = {
  ...
  config: {
    ...
    telegramToken: "",
    telegramChatId: "",
    // 🚀 NUEVAS REGLAS B2B (REPARTO BENEFICIOS DELIVERY)
  ...
  facturas: [
    { id: "rocx2goz2", num: "F-25/001", date: "2025-12-23", paid: true, prov: "Makro", total: "100", dueDate: "2026-01-22", reconciled: true, unidad_negocio: "REST" },
    { id: "6glygcggo", num: "F-25/002", date: "2025-12-28", paid: true, prov: "Distribuidora Rotger S.L.", total: "209.6", dueDate: "2026-01-27", unidad_negocio: "SHOP" }
  ],
  ingredientes: [
