...
export function AutoHideDock<T extends string>({
  ...
  // 🖱️ Mostrar dock al acercar el ratón abajo
  ...
  // ⏱️ Auto-ocultar tras 2.5s si no estamos encima
  useEffect(() => {
  ...
  return (
    <>
      {/* 🔮 Línea flotante sutil (Handle) para indicar que hay un menú oculto */}
      <AnimatePresence>
        {!visible && (
          <motion.div 
      ...
      <AnimatePresence>
        {visible && (
          ...
          >
            ...
            >
              <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar" style={{ WebkitOverflowScrolling: 'touch' }}>
